...
"
" Snippets taken from here and there.
" .. and a lot from MiniVim
"
" Links
...
set virtualedit=onemore " Allow cursor to move just past the end of the line
...
" indent
set tabstop=4
set softtabstop=4 " 4 spaces for 1 tab
set shiftwidth=4 " Indent with 4 spaces for display
set smartindent " Smart indentation
set autoindent " And auto indentation
set list!
...
set backspace=indent,eol,start " Normal behaviour of backspace
...
set gdefault " Add flag g by default for replace
...
" Buffering
set history=200 " undos to keep
set scrolloff=10 " Keep 10 lines after or before when scrolling
set sidescrolloff=5 " ... and for side-scrolling
set hidden "Hide the buffer instead of closing when switching
let &showbreak="\u21aa" " Show a left arrow when wrapping text

" Present lag when hitting escape
set ttimeoutlen=0
set timeoutlen=1000
au InsertEnter * set timeout
au InsertLeave * set notimeout

" Infos display options
set showcmd
set noshowmode " Don't display current mode
...
"
" When opening a file: Reopen at last pos + display info
"
